...
{% for client in clients %}
    ...
    <a href="{{ client.get_absolute_url }}">Подробнее</a>
{% endfor %}

<!-- client_detail.html -->
<h2>{{ client.name }}</h2>
<p>Email: {{ client.email }}</p>
<p><a href="{{ client.get_list_url }}">К списку клиентов</a></p>

from django.urls import path
from app_name.views import ClientListView, ClientDetailView
